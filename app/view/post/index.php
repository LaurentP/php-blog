...
<nav class="pagination">
    <ul>
        ...
        ?>
            <li><a href="<?= HTTP_HOST ?>/blog/<?= $params['currentPage'] - 1 ?>">&laquo; Prev</a></li>
            <?php
        }
        ...
        for ($i = 1; $i <= $params['requiredPages']; $i++) {
            ...
            ?>
                <li><a href="<?= HTTP_HOST ?>/blog/<?= $i ?>" class="pagination-active"><?= $i ?></a></li>
            <?php
            } else {
            ?>
                <li><a href="<?= HTTP_HOST ?>/blog/<?= $i ?>"><?= $i ?></a></li>
            <?php
            }
        }
        ...
        if ($params['currentPage'] < $params['requiredPages']) {
            ?>
            <li><a href="<?= HTTP_HOST ?>/blog/<?= $params['currentPage'] + 1 ?>">Next &raquo;</a></li>
        <?php
        }
        ?>
    </ul>
